...
This package is available in R as [FredApi](https://github.com/markushhh/FredApi) and was inspired by [FredData.jl](https://github.com/micahjsmith/FredData.jl) but is easier to use and focuses more on the time series data.
